...
import { NewsletterFooter } from "@/components/home/newsletter-footer"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex space-x-4 mt-6">
              ...
              <Link href="https://instagram.com/theresaeustacebook" target='_blank' className="text-muted-foreground hover:text-primary transition-colors">
              ...
              <Link href="https://twitter.com/theresaeustacebook" target='_blank' className="text-muted-foreground hover:text-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/books" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors">Books</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/cookies" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors">Cookies</Link></li>
              <li><Link href="/disclaimer" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors">Dislaimer</Link></li>
              <li><Link href="/privacy" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors">Privacy Polish</Link></li>
              <li><Link href="/terms" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors">Terms & Conditions</Link></li>
