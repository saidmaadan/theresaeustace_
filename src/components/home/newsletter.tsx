  ...
  return (
    <section className="border-t bg-muted/40">
      <motion.div
        ...
        whileInView="animate"
        viewport={{ once: true }}
        className="container-center py-20 md:py-32"
      >
        <div className="mx-auto max-w-2xl text-center">
          <motion.div variants={fadeIn('up')} className="space-y-4">
            ...
            Be the first to know about new releases, exclusive sneak peeks, and special giveaways. Sign up for my newsletter and let’s keep the passion alive.
            </p>
          </motion.div>
